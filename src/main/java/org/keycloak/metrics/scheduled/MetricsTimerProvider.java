...
public class MetricsTimerProvider implements TimerProvider {

    private static final Logger logger = Logger.getLogger(MetricsTimerProvider.class);

    private final KeycloakSession session;
    private final Timer timer;
    private final int transactionTimeout;
    private final MetricsTimerProviderFactory factory;

    public MetricsTimerProvider(KeycloakSession session, Timer timer, int transactionTimeout, MetricsTimerProviderFactory factory) {
